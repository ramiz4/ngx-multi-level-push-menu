...
import { MultiLevelPushMenuItem, MultiLevelPushMenuOptions } from '../multi-level-push-menu.model';
...
export class MenuDomService {
    ...
    public appendLevelTitle(
        ...
        if (menuData.icon) {
            this.appendTitleIcon(renderer, title, menuData.icon, options, titleClickHandler);
        }
    ...
    public createGroupIcon(
        ...
        renderer.setStyle(groupIcon, 'padding', isRtl ? '0 0 0 .6em' : '0 .6em 0 0');

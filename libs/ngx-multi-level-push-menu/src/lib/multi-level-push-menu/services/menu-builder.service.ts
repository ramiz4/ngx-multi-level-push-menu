...
export class MenuBuilderService {
    ...
    public createMenuStructure(
        ...
        backItemClickHandler: (backAnchor: HTMLElement, levelHolder: HTMLElement) => void,
    ...
    public createLevelHolder(
        ...
        this.menuDomService.appendLevelTitle(renderer, levelHolder, menuData, options, titleClickHandler);
    ...
    public createBackItem(
        ...
        renderer.appendChild(
            backAnchor,
            renderer.createText(options.backText)
        );
    ...
    public createSubmenu(
        ...
        const initialTransform = options.direction === 'rtl' ?

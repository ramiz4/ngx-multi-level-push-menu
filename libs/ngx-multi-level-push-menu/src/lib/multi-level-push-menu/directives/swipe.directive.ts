...
export class SwipeDirective {
    ...
    onTouchStart(event: TouchEvent): void {
        if (!this.deviceDetectorService.isSwipeEnabled('touchscreen', this.swipeEnabled)) return;
    ...
    onTouchMove(event: TouchEvent): void {
        ...
        const threshold = this.deviceDetectorService.getSwipeThreshold(this.overlapWidth);
    ...
    onMouseDown(event: MouseEvent): void {
        if (!this.deviceDetectorService.isSwipeEnabled('desktop', this.swipeEnabled)) return;

...
| `defaultItemIcon`               | `string`                                                              | Built-in dot SVG     | Fallback icon for items without a custom icon                                                             |
| `overlapWidth`                  | `string \| number`                                                    | `55`                 | Width of each ancestor rail; a number is pixels and also influences swipe threshold                       |
...
| `fullCollapse`                  | `boolean`                                                             | `false`              | Hide navigation completely instead of leaving the full-height item-icon rail visible                      |
